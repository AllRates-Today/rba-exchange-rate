'use strict';
// Reserve Bank of Australia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/rba';
...
/** Latest rate for one pair, e.g. getRate('AUD', 'USD', { apiKey }). */
